                  ...
                  <div class="nav-user-list">
                    <ul>
                      ...
                      <li class="nav-user-avatar">
                        <div>
                          <span class="avatar" :style="{backgroundImage:'url('+userInfo.avatar+')'}">
                          </span>
                        </div>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...mapMutations(['ADD_CART', 'INIT_BUYCART', 'ADD_ANIMATION', 'SHOW_CART', 'RECORD_USERINFO', 'EDIT_CART', 'DESTORY_USERINFO']),
      handleIconClick (ev) {
      ...
      // 控制顶部
      navFixed () {
        if (this.$route.path === '/goods' || this.$route.path === '/' || this.$route.path.startsWith('/goodsDetails')) {
